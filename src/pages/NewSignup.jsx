      ...
      <div className="row" style={{ justifyContent: 'space-around', marginTop: '5vh' }}>
        <div className="col">
            <form action="">
              ...
              <br />
              <input
                className="pill-button" style={{ width: '100%', marginTop: '5vh' }} type="submit" value="Sign Up"/>
            </form>

          <h6 style={{ textAlign: 'center', marginTop: '2vh', textDecoration: 'none' }}>
            Already Signed Up? <Link to="/newlogin" style={{ textAlign: 'center', textDecoration: 'none' }}><b>Login</b></Link>
          </h6>
